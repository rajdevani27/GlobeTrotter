...
export function ActivityDialog({
  ...
  return (
    <Modal
      ...
      description={editing ? "Update the details of this stop." : "Add a new stop to your itinerary."}
      footer={
        <>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <Field label="Estimated cost (₹)" htmlFor="a-cost" className="sm:col-span-2">
          <input
            ...
            onChange={(e) => setForm({ ...form, estimatedCost: Math.max(0, Number(e.target.value) || 0) })}
            className={inputClass}
          />
        </Field>
      </div>
