export type Category =
  "Adventure" | "Sightseeing" | "Food" | "Shopping" | "Relaxation" | "Culture" | "Travel";
  ...
  return [
    ...
    },
    {
      ...
      activities: [
        ...
        {
          time: "17:00",
          name: "Sunset Sightseeing Cruise",
          category: "Sightseeing",
          duration: "1.5 hrs",
          travelTime: "15 min",
          travelMode: "metro",
...
export function generateItinerary(trip: Trip): DayPlan[] {
  ...
  for (let i = 0; i < numDays; i++) {
    ...
    const activities: Activity[] = template.activities.map((a, idx) => ({
      ...
      day,
      location:
        idx === 0 && a.category === "Travel"
          ? city
          : `${AREAS[(i + idx) % AREAS.length]}, ${city.split(",")[0]}`,
    }));
    days.push({
      day,
...
export function categoryTotals(days: DayPlan[]): CategoryTotals {
  const totals: CategoryTotals = { Flights: 0, Hotels: 0, Food: 0, Activities: 0, Shopping: 0 };
